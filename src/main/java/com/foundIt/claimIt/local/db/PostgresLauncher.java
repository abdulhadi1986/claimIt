...
public class PostgresLauncher {
    ...
    static final String DB_USER = "claimify";
    static final String DB_PASSWORD = "claimify";
    static final String DB_NAME = "claimify";
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("✅ started claimify-database on port " + pg.getPort());
